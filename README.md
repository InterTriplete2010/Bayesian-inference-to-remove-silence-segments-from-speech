...
Please, keep in mind that if the audio file has 2 channels, the code assumes that the 2-channels are identical and therefore analyzes only 1 of them to create the final 2-channel audio file with silence removed.
